...
import asia.ncc.erp.platform.domain.enumeration.ProjectType;
import asia.ncc.erp.platform.repository.ProjectRepository;
import asia.ncc.erp.platform.service.dto.ProjectDTO;
import asia.ncc.erp.platform.service.mapper.ProjectMapper;
...
class ProjectResourceIT {
    ...
    private static final ProjectType DEFAULT_PROJECT_TYPE = ProjectType.FIXEDPRICE;
    private static final ProjectType UPDATED_PROJECT_TYPE = ProjectType.TNM;
    ...
    void putNewProject() throws Exception {
        ...
        updatedProject.name(UPDATED_NAME).startDate(UPDATED_START_DATE).customer(UPDATED_CUSTOMER).projectType(UPDATED_PROJECT_TYPE);
    ...
    void partialUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).projectType(UPDATED_PROJECT_TYPE);
    ...
    void fullUpdateProjectWithPatch() throws Exception {
        ...
        partialUpdatedProject.name(UPDATED_NAME).startDate(UPDATED_START_DATE).customer(UPDATED_CUSTOMER).projectType(UPDATED_PROJECT_TYPE);

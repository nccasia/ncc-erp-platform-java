...
import asia.ncc.erp.projects.repository.ProjectRepository;
import asia.ncc.erp.projects.service.ProjectService;
import asia.ncc.erp.projects.service.dto.ProjectDTO;
import asia.ncc.erp.projects.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link asia.ncc.erp.projects.domain.Project}.
 */
@RestController
@RequestMapping("/api")

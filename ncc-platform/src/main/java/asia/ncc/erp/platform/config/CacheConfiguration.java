...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, asia.ncc.erp.platform.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, asia.ncc.erp.platform.repository.UserRepository.USERS_BY_EMAIL_CACHE);

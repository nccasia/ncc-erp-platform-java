...
import asia.ncc.erp.platform.service.ProjectService;
import asia.ncc.erp.platform.service.dto.ProjectDTO;
import asia.ncc.erp.platform.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link asia.ncc.erp.platform.domain.Project}.
 */
@RestController
@RequestMapping("/api")
